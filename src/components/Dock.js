...
import CommsIcon from "../icons/comms.svg";
import PropIcon from "../icons/prop.svg";
import MechIcon from "../icons/mech.svg";
import PowerIcon from "../icons/power.svg";
import AvionicsIcon from "../icons/avionics.svg";
import GNCIcon from "../icons/gnc.svg";
  ...
  return (
    <div className="flex items-center justify-center pt-10 space-x-8">
      <div className="relative flex px-2 pt-5 pb-4 bg-blue-900 rounded-t-3xl">
        ...
        {bars.map((bar, index) => (
          <a href="#" key={index} className="flex flex-col items-center px-4 group">
            {bar.icon}
